...
This code is a simple tidy-up of the [R Causal Impact package](https://google.github.io/CausalImpact/CausalImpact.html) which is created and shared by Google. The Google package uses Bayesian structural time-series models to make a counterfactual prediction of a response variable and compare this to actual data, to determine the effect of a given event on this variable.
